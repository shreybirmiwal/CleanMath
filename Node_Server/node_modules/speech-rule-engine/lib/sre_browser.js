...
$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};$jscomp.arrayFromIterator=function(a){for(var b,c=[];!(b=a.next()).done;)c.push(b.value);return c};
...
goog.dependencies_.nameToPath[a]:null},goog.findBasePath_(),goog.global.CLOSURE_NO_DEPS||goog.importScript_(goog.basePath+"deps.js"));goog.hasBadLetScoping=null;goog.useSafari10Workaround=function(){if(null==goog.hasBadLetScoping){try{var a=!eval('"use strict";let x = 1; function f() { return typeof x; };f() == "number";')}catch(b){a=!1}goog.hasBadLetScoping=a}return goog.hasBadLetScoping};goog.workaroundSafari10EvalBug=function(a){return"(function(){"+a+"\n;})();\n"};
...
MATRIX:"matrix",VECTOR:"vector",CASES:"cases",TABLE:"table",PROOF:"proof",LEFT:"left",RIGHT:"right",UP:"up",DOWN:"down",FINAL:"final",SINGLE:"single",HYP:"hyp",AXIOM:"axiom",UNKNOWN:"unknown",PROTECTED:"protected"};
...
this.id]);this.addExternalAttributes_(a);return a};sre.SemanticNode.prototype.addExternalAttributes_=function(a){for(var b in this.attributes)a.push([b,this.attributes[b]])};sre.SemanticNode.prototype.xmlAnnotation=function(){var a=[],b;for(b in this.annotation)this.annotation[b].forEach(function(c){a.push(b+":"+c)});return a.join(";")};
...
sre.SemanticProcessor.prototype.proof=function(a,b,c){b.inference||console.log("Noise");a=this.inference(a,b,c);b.proof&&(a.role=sre.SemanticAttr.Role.PROOF);return a};
sre.SemanticProcessor.prototype.inference=function(a,b,c){if(b.inferenceRule){a=$jscomp.makeIterator(this.getTable(a,[],c));c=a.next().value;var d=a.next().value;return b=this.factory_.makeBranchNode(sre.SemanticAttr.Type.INFERENCE,[c,d],[])}d=b.labelledRule;var e=sre.DomUtil.toArray(a.childNodes);b=[];"left"!==d&&"both"!==d||b.push(this.getLabel(a,e,c,sre.SemanticAttr.Role.LEFT));"right"!==d&&"both"!==d||b.push(this.getLabel(a,e,c,sre.SemanticAttr.Role.RIGHT));d=$jscomp.makeIterator(this.getTable(a,
e,c));c=d.next().value;d=d.next().value;b=this.factory_.makeBranchNode(sre.SemanticAttr.Type.INFERENCE,[c,d],b);b.mathmlTree=a;return b};sre.SemanticProcessor.prototype.getLabel=function(a,b,c,d){a=b.find(function(a){return sre.SemanticProcessor.findSemantics(a,"prooflabel",d)});console.log(a);c=this.factory_.makeBranchNode(sre.SemanticAttr.Type.RULELABEL,c(a.childNodes),[]);c.role=d;return c};
sre.SemanticProcessor.prototype.getTable=function(a,b,c){console.log("Getting table");console.log(a);b=b.length?b.find(function(a){return sre.SemanticProcessor.findSemantics(a,"inferenceRule")}):a;console.log("Getting top row");console.log(b);a=b.childNodes[0].childNodes[0].childNodes[0];var d=sre.DomUtil.toArray(a.childNodes[0].childNodes);console.log(a);console.log(d);var e=[],f=1;d=$jscomp.makeIterator(d);for(var g=d.next();!g.done;g=d.next())g=g.value,f%2&&e.push(g.childNodes[0]),f++;e=c(e);b=
b.childNodes[1];c=c(b.childNodes[0].childNodes)[0];e=this.factory_.makeBranchNode(sre.SemanticAttr.Type.PREMISES,e,[]);e.mathmlTree=a;c=this.factory_.makeBranchNode(sre.SemanticAttr.Type.CONCLUSION,[c],[]);c.mathmlTree=b.childNodes[0].childNodes[0];return[c,e]};sre.SemanticProcessor.findSemantics=function(a,b,c){c=null==c?null:c;return(a=sre.SemanticProcessor.getSemantics(a))&&a[b]?null==c?!0:a[b]===c:!1};
sre.SemanticProcessor.getSemantics=function(a){return(a=a.getAttribute("semantics"))?sre.SemanticProcessor.separateSemantics(a):null};sre.SemanticProcessor.removePrefix=function(a){a=$jscomp.makeIterator(a.split("_"));a.next();return $jscomp.arrayFromIterator(a).join("_")};sre.SemanticProcessor.separateSemantics=function(a){var b={};a.split(";").forEach(function(a){var c=$jscomp.makeIterator(a.split(":"));a=c.next().value;c=c.next().value;b[sre.SemanticProcessor.removePrefix(a)]=c});return b};sre.SemanticMathml=function(){sre.SemanticAbstractParser.call(this,"MathML");this.parseMap_={SEMANTICS:goog.bind(this.semantics_,this),MATH:goog.bind(this.rows_,this),MROW:goog.bind(this.rows_,this),MPADDED:goog.bind(this.rows_,this),MSTYLE:goog.bind(this.rows_,this),MFRAC:goog.bind(this.fraction_,this),MSUB:goog.bind(this.limits_,this),MSUP:goog.bind(this.limits_,this),MSUBSUP:goog.bind(this.limits_,this),MOVER:goog.bind(this.limits_,this),MUNDER:goog.bind(this.limits_,this),MUNDEROVER:goog.bind(this.limits_,
...
sre.SemanticMathml.prototype.rows_=function(a,b){var c=a.getAttribute("semantics");if(c&&c.match("bspr_"))return sre.SemanticProcessor.proof(a,c,goog.bind(this.parseNodes_,this));b=sre.SemanticUtil.purgeNodes(b);b=1===b.length?this.parse(b[0]):sre.SemanticProcessor.getInstance().row(this.parseNodes_(b));b.mathml.unshift(a);return b};sre.SemanticMathml.prototype.fraction_=function(a,b){return sre.SemanticProcessor.getInstance().fractionLikeNode(a.getAttribute("linethickness"),this.parse(b[0]),this.parse(b[1]))};
...
sre.SemanticMathml.prototype.sqrt_=function(a,b){a=this.parseNodes_(sre.SemanticUtil.purgeNodes(b));return this.getFactory().makeBranchNode(sre.SemanticAttr.Type.SQRT,[sre.SemanticProcessor.getInstance().row(a)],[])};
sre.SemanticMathml.prototype.table_=function(a,b){var c=a.getAttribute("semantics");if(c&&c.match("bspr_"))return sre.SemanticProcessor.proof(a,c,goog.bind(this.parseNodes_,this));a=this.getFactory().makeBranchNode(sre.SemanticAttr.Type.TABLE,this.parseNodes_(b),[]);sre.SemanticProcessor.tableToMultiline(a);return a};sre.SemanticMathml.prototype.tableRow_=function(a,b){a=this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ROW,this.parseNodes_(b),[]);a.role=sre.SemanticAttr.Role.TABLE;return a};
sre.SemanticMathml.prototype.tableLabeledRow_=function(a,b){if(!b.length)return this.tableRow_(a,b);a=this.parse(b[0]);a.role=sre.SemanticAttr.Role.LABEL;b=this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ROW,this.parseNodes_(b.slice(1)),[a]);b.role=sre.SemanticAttr.Role.TABLE;return b};
...
sre.CaseProof.prototype.getMathml=function(){console.log("Getting math for: "+this.semantic.type);console.log(this.mml);if(!this.semantic.childNodes.length)return this.mml;this.semantic.childNodes.forEach(function(a){sre.EnrichMathml.walkTree(a)});sre.EnrichMathml.setAttributes(this.mml,this.semantic);return this.mml};sre.CaseTable=function(a){sre.AbstractEnrichCase.call(this,a);this.mml=a.mathmlTree;this.inner=[]};goog.inherits(sre.CaseTable,sre.AbstractEnrichCase);sre.CaseTable.test=function(a){return a.mathmlTree&&(a.type===sre.SemanticAttr.Type.MATRIX||a.type===sre.SemanticAttr.Type.VECTOR||a.type===sre.SemanticAttr.Type.CASES)};
...
sre.Messages.NAVIGATE={COLLAPSIBLE:"",EXPANDABLE:"",LEVEL:""};sre.MathspeakUtil={};sre.MathspeakUtil.spaceoutText=function(a){return a.textContent.split("").join(" ")};sre.MathspeakUtil.spaceoutNumber=function(a){a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.Semantic.Type.NUMBER,g=e.match(/\W/)?sre.SemanticAttr.lookupMeaning(e).role:sre.Semantic.Role.PROTECTED;e=c.parseFromString("<"+f+' role="'+g+'">'+e+"</"+f+">","text/xml");b.push(e.documentElement)}return b};
...
sre.ClearspeakRules.initClearspeakRules_=function(){(0,sre.ClearspeakRules.defineRule_)("stree","clearspeak.default","[n] ./*[1]","self::stree");(0,sre.ClearspeakRules.defineRule_)("unknown","clearspeak.default","[n] text()","self::unknown");(0,sre.ClearspeakRules.defineRule_)("protected","clearspeak.default","[t] text()","self::*",'@role="protected"');(0,sre.ClearspeakRules.defineRule_)("omit-empty","clearspeak.default",'[p] (pause:"short")',"self::empty");(0,sre.ClearspeakRules.defineRule_)("font","clearspeak.default",
'[t] @font; [n] self::* (grammar:ignoreFont=@font,pause:"short")',"self::*","@font",'not(contains(@grammar, "ignoreFont"))','@font!="normal"');(0,sre.ClearspeakRules.defineRule_)("font-identifier","clearspeak.default",'[t] @font; [n] self::* (grammar:ignoreFont=@font,pause:"short")',"self::identifier","string-length(text())=1","@font",'@font="normal"','not(contains(@grammar, "ignoreFont"))','@role!="unit"');(0,sre.ClearspeakRules.defineRule_)("omit-font","clearspeak.default","[n] self::* (grammar:ignoreFont=@font)",
"self::identifier","string-length(text())=1","@font",'not(contains(@grammar, "ignoreFont"))','@font="italic"');(0,sre.ClearspeakRules.defineRule_)("german-font","clearspeak.default",'[t] "German"; [n] self::* (grammar:ignoreFont=@font)',"self::*","@font",'not(contains(@grammar, "ignoreFont"))','@font="fraktur"');(0,sre.ClearspeakRules.defineRule_)("german-font","clearspeak.default",'[t] "bold German"; [n] self::* (grammar:ignoreFont=@font)',"self::*","@font",'not(contains(@grammar, "ignoreFont"))',
'@font="bold-fraktur"');(0,sre.ClearspeakRules.defineRule_)("text","clearspeak.default","[n] text()","self::text");(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.default",'[n] text() (pitch:0.6,grammar:ignoreFont="cap")',"self::identifier",'@role="latinletter" or @role="greekletter" or @role="simple function"',"CQFisCapital");(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps","[n] text()","self::identifier",'@role="latinletter" or @role="greekletter"',"CQFisCapital");
(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps",'[p] (pause:"short"); [n] text()',"self::identifier",'@role="latinletter" or @role="greekletter"',"CQFisCapital","preceding-sibling::*[1]",'not(name(preceding-sibling::*[1])="function")','not(contains(@grammar, "angle"))');(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps",'[n] text() (pause:"short")',"self::identifier",'@role="latinletter" or @role="greekletter"',"CQFisCapital","following-sibling::*[1]");
...
"clearspeak.default",'[n] children/*[1]; [t] "from"; [n] children/*[2]',"self::underscore",'@role="underover"','children/*[2][@role!="underaccent"]');(0,sre.ClearspeakRules.defineRule_)("number","clearspeak.default","[n] text()","self::number");(0,sre.ClearspeakRules.defineRule_)("mixed-number","clearspeak.default",'[n] children/*[1]; [t] "and"; [n] children/*[2]; ',"self::number",'@role="mixed"');(0,sre.ClearspeakRules.defineRule_)("number-with-chars","clearspeak.default",'[t] "number"; [m] CQFspaceoutNumber',
"self::number",'"" != translate(text(), "0123456789.,", "")','text() != translate(text(), "0123456789.,", "")');(0,sre.ClearspeakRules.defineRule_)("decimal-period","clearspeak.default",'[t] "the repeating decimal"; [n] children/*[1] (grammar:spaceout); [t] "point followed by repeating digits";  [n] children/*[3]/children/*[1] (grammar:spaceout)',"self::punctuated",'@role="sequence"',"count(./content/*)=1",'./content/*[1][@role="fullstop"]','name(children/*[1])="number"','children/*[1][@role="integer"]',
...
"self::identifier","string-length(text())=1","@font",'@font="normal"','not(contains(@grammar, "ignoreFont"))','@role!="unit"');(0,sre.NemethRules.defineRule_)("omit-font","default.default","[n] . (grammar:ignoreFont=@font)","self::identifier","string-length(text())=1","@font",'not(contains(@grammar, "ignoreFont"))','@font="italic"');(0,sre.NemethRules.defineRule_)("number","default.default","[n] text()","self::number");(0,sre.NemethRules.defineRule_)("number","default.default",'[t] "\u283c"; [n] text()',
"self::number",'name(..)="stree"');(0,sre.NemethRules.defineRule_)("number","default.default",'[t] "\u283c"; [n] text()',"self::number",'name(../..)="cell"');(0,sre.NemethRules.defineRule_)("number","default.default",'[t] "\u283c"; [n] text()',"self::number",'name(../..)="punctuated"',"not(ancestor::fenced)");(0,sre.NemethRules.defineRule_)("mixed-number","default.default","[n] children/*[1]; [n] children/*[2]; ","self::number",'@role="mixed"');(0,sre.NemethRules.defineRule_)("number-with-chars",
"default.default",'[t] "\u283c"; [m] CQFspaceoutNumber',"self::number",'"" != translate(text(), "0123456789.,", "")','text() != translate(text(), "0123456789.,", "")');(0,sre.NemethRules.defineSpecialisedRule_)("number-with-chars","default.default","nemeth.brief",'[t] "Num"; [m] CQFspaceoutNumber');(0,sre.NemethRules.defineSpecialisedRule_)("number-with-chars","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("number-as-upper-word","default.default",'[t] "UpperWord"; [t] CSFspaceoutText',
...
(0,sre.NemethRules.defineRule_)("number-baseline","default.default",'[t] "Baseline"; [n] text()',"self::number",'not(contains(@grammar, "ignoreFont"))',"preceding-sibling::identifier",'preceding-sibling::*[1][@role="latinletter" or @role="greekletter" or @role="otherletter"]','parent::*/parent::infixop[@role="implicit"]');(0,sre.NemethRules.defineSpecialisedRule_)("number-baseline","default.default","nemeth.brief",'[t] "Base"; [n] text()');(0,sre.NemethRules.defineSpecialisedRule_)("number-baseline",
"nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("number-baseline-font","default.default",'[t] "Baseline"; [t] @font; [n] . (grammar:ignoreFont=@font)',"self::number","@font",'not(contains(@grammar, "ignoreFont"))','@font!="normal"',"preceding-sibling::identifier",'preceding-sibling::*[@role="latinletter" or @role="greekletter" or @role="otherletter"]','parent::*/parent::infixop[@role="implicit"]');(0,sre.NemethRules.defineSpecialisedRule_)("number-baseline-font","default.default",
"nemeth.brief",'[t] "Base"; [n] text()');(0,sre.NemethRules.defineSpecialisedRule_)("number-baseline-font","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("identifier","default.default","[m] CQFspaceoutIdentifier","self::identifier","string-length(text())>1",'@role!="unit"','@role!="protected"','not(@font) or @font="normal" or contains(@grammar, "ignoreFont")');(0,sre.NemethRules.defineRule_)("identifier","default.default","[n] text()","self::identifier",'@role="protected"');(0,sre.NemethRules.defineRule_)("prefix",
"default.default","[n] text(); [n] children/*[1]","self::prefixop");(0,sre.NemethRules.defineRule_)("postfix","default.default","[n] children/*[1]; [n] text()","self::postfixop");(0,sre.NemethRules.defineRule_)("binary-operation","default.default","[m] children/* (sepFunc:CTXFcontentIterator);","self::infixop");(0,sre.NemethRules.defineRule_)("implicit","default.default","[m] children/*","self::infixop",'@role="implicit"');(0,sre.NemethRules.defineRuleAlias_)("implicit","self::infixop",'@role="leftsuper" or @role="leftsub" or @role="rightsuper" or @role="rightsub"');
(0,sre.NemethRules.defineRule_)("function-unknown","default.default","[n] children/*[1]; [n] children/*[2]","self::appl");(0,sre.NemethRules.defineRule_)("function-prefix","default.default","[n] children/*[1]; [n] children/*[2]","self::appl",'children/*[1][@role="prefix function"]');(0,sre.NemethRules.defineRule_)("fences-open-close","default.default","[n] content/*[1]; [n] children/*[1]; [n] content/*[2]","self::fenced",'@role="leftright"');(0,sre.NemethRules.defineRule_)("fences-neutral","default.default",
"[n] content/*[1]; [n] children/*[1]; [n] content/*[2]","self::fenced",'@role="neutral"');(0,sre.NemethRules.defineRule_)("fences-set","default.default",'[t] "StartSet"; [n] children/*[1]; [t] "EndSet"',"self::fenced",'@role="set empty" or @role="set extended" or @role="set singleton" or @role="set collection"','not(name(../..)="appl")');(0,sre.NemethRules.defineSpecialisedRule_)("fences-set","default.default","nemeth.sbrief",'[t] "Set"; [n] children/*[1]; [t] "EndSet"');(0,sre.NemethRules.defineRule_)("text",
"default.default","[n] text()","self::text");(0,sre.NemethRules.defineRule_)("factorial","default.default",'[t] "\u282f"',"self::punctuation",'text()="!"','name(preceding-sibling::*[1])!="text"');(0,sre.NemethRules.defineRule_)("single-prime","default.default",'[t] "prime"',"self::punctuated",'@role="prime"',"count(children/*)=1");(0,sre.NemethRules.defineRule_)("double-prime","default.default",'[t] "double-prime"',"self::punctuated",'@role="prime"',"count(children/*)=2");(0,sre.NemethRules.defineRule_)("triple-prime",
"default.default",'[t] "triple-prime"',"self::punctuated",'@role="prime"',"count(children/*)=3");(0,sre.NemethRules.defineRule_)("quadruple-prime","default.default",'[t] "quadruple-prime"',"self::punctuated",'@role="prime"',"count(children/*)=4");(0,sre.NemethRules.defineRule_)("counted-prime","default.default",'[t] count(children/*); [t] "prime"',"self::punctuated",'@role="prime"');(0,sre.NemethRules.defineRule_)("fraction","default.default","[t] CSFopenFraction; [n] children/*[1]; [t] CSFoverFraction; [n] children/*[2]; [t] CSFcloseFraction",
"self::fraction");(0,sre.NemethRules.defineRule_)("fraction","nemeth.brief","[t] CSFopenFracBrief; [n] children/*[1]; [t] CSFoverFraction; [n] children/*[2]; [t] CSFcloseFracBrief","self::fraction");(0,sre.NemethRules.defineRule_)("fraction","nemeth.sbrief","[t] CSFopenFracSbrief; [n] children/*[1]; [t] CSFoverFracSbrief; [n] children/*[2]; [t] CSFcloseFracSbrief","self::fraction");(0,sre.NemethRules.defineRule_)("vulgar-fraction","default.default","[t] CSFvulgarFraction","self::fraction",'@role="vulgar"',
"CQFvulgarFractionSmall");(0,sre.NemethRules.defineSpecialisedRule_)("vulgar-fraction","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("vulgar-fraction","default.default","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("continued-fraction-outer","default.default",'[t] "ContinuedFraction"; [n] children/*[1];[t] "Over"; [n] children/*[2]',"self::fraction","not(ancestor::fraction)",'children/*[2]/descendant-or-self::*[@role="ellipsis" and not(following-sibling::*)]');(0,sre.NemethRules.defineSpecialisedRule_)("continued-fraction-outer",
"default.default","nemeth.brief",'[t] "ContinuedFrac"; [n] children/*[1];[t] "Over"; [n] children/*[2]');(0,sre.NemethRules.defineSpecialisedRule_)("continued-fraction-outer","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("continued-fraction-inner","default.default",'[t] "StartFraction"; [n] children/*[1];[t] "Over"; [n] children/*[2]',"self::fraction","ancestor::fraction",'children/*[2]/descendant-or-self::*[@role="ellipsis" and not(following-sibling::*)]');(0,sre.NemethRules.defineSpecialisedRule_)("continued-fraction-inner",
"default.default","nemeth.brief",'[t] "StartFrac"; [n] children/*[1];[t] "Over"; [n] children/*[2]');(0,sre.NemethRules.defineSpecialisedRule_)("continued-fraction-inner","nemeth.brief","nemeth.sbrief",'[t] "Frac"; [n] children/*[1];[t] "Over"; [n] children/*[2]');(0,sre.NemethRules.defineRule_)("sqrt","default.default","[t] CSFopenRadicalVerbose; [n] children/*[1]; [t] CSFcloseRadicalVerbose","self::sqrt");(0,sre.NemethRules.defineRule_)("root","default.default",'[t] CSFindexRadicalVerbose; [n] children/*[1];[t] "\u281c"; [n] children/*[2]; [t] CSFcloseRadicalVerbose',
"self::root");(0,sre.NemethRules.defineRule_)("root","nemeth.brief","[t] CSFindexRadicalBrief; [n] children/*[1];[t] CSFopenRadicalBrief; [n] children/*[2]; [t] CSFcloseRadicalBrief","self::root");(0,sre.NemethRules.defineRule_)("root","nemeth.sbrief","[t] CSFindexRadicalSbrief; [n] children/*[1];[t] CSFopenRadicalSbrief; [n] children/*[2]; [t] CSFcloseRadicalBrief","self::root");(0,sre.NemethRules.defineRule_)("limboth","default.default",'[t] "\u2810"; [n] children/*[1]; [t] CSFunderscript; [n] children/*[2];[t] CSFoverscript; [n] children/*[3]',
"self::limboth",'name(../..)="underscore" or name(../..)="overscore"','following-sibling::*[@role!="underaccent" and @role!="overaccent"]');(0,sre.NemethRules.defineRule_)("limlower","default.default",'[t] "\u2810"; [n] children/*[1]; [t] CSFunderscript; [n] children/*[2];',"self::limlower",'name(../..)="underscore" or name(../..)="overscore"','following-sibling::*[@role!="underaccent" and @role!="overaccent"]');(0,sre.NemethRules.defineRule_)("limupper","default.default",'[t] "\u2810"; [n] children/*[1]; [t] CSFoverscript; [n] children/*[2];',
"self::limupper",'name(../..)="underscore" or name(../..)="overscore"','following-sibling::*[@role!="underaccent" and @role!="overaccent"]');(0,sre.NemethRules.defineRuleAlias_)("limlower","self::underscore",'@role="limit function"','name(../..)="underscore" or name(../..)="overscore"','following-sibling::*[@role!="underaccent" and @role!="overaccent"]');(0,sre.NemethRules.defineRuleAlias_)("limlower","self::underscore",'children/*[2][@role!="underaccent"]','name(../..)="underscore" or name(../..)="overscore"',
'following-sibling::*[@role!="underaccent" and @role!="overaccent"]');(0,sre.NemethRules.defineRuleAlias_)("limupper","self::overscore",'children/*[2][@role!="overaccent"]','name(../..)="underscore" or name(../..)="overscore"','following-sibling::*[@role!="underaccent" and @role!="overaccent"]');(0,sre.NemethRules.defineRule_)("limboth-end","default.default",'[t] "\u2810"; [n] children/*[1]; [t] CSFunderscript; [n] children/*[2];[t] CSFoverscript; [n] children/*[3]; [t] "\u283b"',"self::limboth");
...
(0,sre.NemethRules.defineRule_)("subscript","nemeth.brief","[n] children/*[1]; [t] CSFsubscriptBrief; [n] children/*[2]","self::subscript");(0,sre.NemethRules.defineSpecialisedRule_)("subscript","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("subscript-simple","default.default","[n] children/*[1]; [n] children/*[2]","self::subscript",'name(./children/*[1])="identifier"','name(./children/*[2])="number"','./children/*[2][@role!="mixed"]','./children/*[2][@role!="othernumber"]');(0,sre.NemethRules.defineSpecialisedRule_)("subscript-simple",
"default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("subscript-simple","default.default","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("subscript-baseline","default.default","[n] children/*[1]; [t] CSFsubscriptVerbose; [n] children/*[2]; [t] CSFbaselineVerbose","self::subscript","following-sibling::*",'not(name(following-sibling::subscript/children/*[1])="empty" or (name(following-sibling::infixop[@role="implicit"]/children/*[1])="subscript" and name(following-sibling::*/children/*[1]/children/*[1])="empty")) and @role!="subsup"',
'not(following-sibling::*[@role="rightsuper" or @role="rightsub" or @role="leftsub" or @role="leftsub"])');(0,sre.NemethRules.defineSpecialisedRule_)("subscript-baseline","default.default","nemeth.brief","[n] children/*[1]; [t] CSFsubscriptBrief; [n] children/*[2]; [t] CSFbaselineBrief");(0,sre.NemethRules.defineSpecialisedRule_)("subscript-baseline","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("subscript-baseline","self::subscript","not(following-sibling::*)","ancestor::fenced|ancestor::root|ancestor::sqrt|ancestor::punctuated|ancestor::fraction",
'not(ancestor::punctuated[@role="leftsuper" or @role="rightsub" or @role="rightsuper" or @role="rightsub"])');(0,sre.NemethRules.defineRuleAlias_)("subscript-baseline","self::subscript","not(following-sibling::*)","ancestor::relseq|ancestor::multirel",sre.MathspeakUtil.generateBaselineConstraint());(0,sre.NemethRules.defineRuleAlias_)("subscript-baseline","self::subscript","not(following-sibling::*)","@embellished");(0,sre.NemethRules.defineRule_)("subscript-empty-sup","default.default","[n] children/*[1]; [n] children/*[2]",
"self::subscript",'name(children/*[2])="infixop"','name(children/*[2][@role="implicit"]/children/*[1])="superscript"','name(children/*[2]/children/*[1]/children/*[1])="empty"');(0,sre.NemethRules.defineSpecialisedRule_)("subscript-empty-sup","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("subscript-empty-sup","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("subscript-empty-sup","self::subscript",'name(children/*[2])="superscript"','name(children/*[2]/children/*[1])="empty"');
(0,sre.NemethRules.defineRule_)("superscript","default.default","[n] children/*[1]; [t] CSFsuperscriptVerbose; [n] children/*[2]","self::superscript");(0,sre.NemethRules.defineSpecialisedRule_)("superscript","default.default","nemeth.brief","[n] children/*[1]; [t] CSFsuperscriptBrief; [n] children/*[2]");(0,sre.NemethRules.defineSpecialisedRule_)("superscript","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("superscript-baseline","default.default","[n] children/*[1]; [t] CSFsuperscriptVerbose; [n] children/*[2];[t] CSFbaselineVerbose",
"self::superscript","following-sibling::*",'not(name(following-sibling::superscript/children/*[1])="empty" or (name(following-sibling::infixop[@role="implicit"]/children/*[1])="superscript" and name(following-sibling::*/children/*[1]/children/*[1])="empty")) and not(following-sibling::*[@role="rightsuper" or @role="rightsub" or @role="leftsub" or @role="leftsub"])');(0,sre.NemethRules.defineSpecialisedRule_)("superscript-baseline","default.default","nemeth.brief","[n] children/*[1]; [t] CSFsuperscriptBrief; [n] children/*[2];[t] CSFbaselineBrief");
(0,sre.NemethRules.defineSpecialisedRule_)("superscript-baseline","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("superscript-baseline","self::superscript","not(following-sibling::*)","ancestor::punctuated",'ancestor::*/following-sibling::* and not(ancestor::punctuated[@role="leftsuper" or @role="rightsub" or @role="rightsuper" or @role="rightsub"])');(0,sre.NemethRules.defineRuleAlias_)("superscript-baseline","self::superscript","not(following-sibling::*)","ancestor::fraction|ancestor::fenced|ancestor::root|ancestor::sqrt");
(0,sre.NemethRules.defineRuleAlias_)("superscript-baseline","self::superscript","not(following-sibling::*)","ancestor::relseq|ancestor::multirel","not(@embellished)",sre.MathspeakUtil.generateBaselineConstraint());(0,sre.NemethRules.defineRuleAlias_)("superscript-baseline","self::superscript","not(following-sibling::*)","@embellished",'not(children/*[2][@role="prime"])');(0,sre.NemethRules.defineRule_)("superscript-empty-sub","default.default","[n] children/*[1]; [n] children/*[2]","self::superscript",
'name(children/*[2])="infixop"','name(children/*[2][@role="implicit"]/children/*[1])="subscript"','name(children/*[2]/children/*[1]/children/*[1])="empty"');(0,sre.NemethRules.defineSpecialisedRule_)("superscript-empty-sub","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("superscript-empty-sub","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("superscript-empty-sub","self::superscript",'name(children/*[2])="subscript"','name(children/*[2]/children/*[1])="empty"');
(0,sre.NemethRules.defineRule_)("prime","default.default","[n] children/*[1]; [n] children/*[2]","self::superscript","children/*[2]",'children/*[2][@role="prime"]');(0,sre.NemethRules.defineSpecialisedRule_)("prime","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("prime","default.default","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("prime-subscript","default.default","[n] children/*[1]/children/*[1]; [n] children/*[2]; [t] CSFsubscriptVerbose; [n] children/*[1]/children/*[2]",
"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="subscript"',"not(following-sibling::*)");(0,sre.NemethRules.defineSpecialisedRule_)("prime-subscript","default.default","nemeth.brief","[n] children/*[1]/children/*[1]; [n] children/*[2]; [t] CSFsubscriptBrief; [n] children/*[1]/children/*[2]");(0,sre.NemethRules.defineSpecialisedRule_)("prime-subscript","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("prime-subscript-baseline","default.default","[n] children/*[1]/children/*[1]; [n] children/*[2]; [t] CSFsubscriptVerbose; [n] children/*[1]/children/*[2]; [t] CSFbaselineVerbose",
"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="subscript"',"following-sibling::*");(0,sre.NemethRules.defineSpecialisedRule_)("prime-subscript-baseline","default.default","nemeth.brief","[n] children/*[1]/children/*[1]; [n] children/*[2]; [t] CSFsubscriptBrief; [n] children/*[1]/children/*[2]; [t] CSFbaselineBrief");(0,sre.NemethRules.defineSpecialisedRule_)("prime-subscript-baseline","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("prime-subscript-baseline",
...
'children/*[1]/children/*[2][@role!="othernumber"]');(0,sre.NemethRules.defineSpecialisedRule_)("prime-subscript-simple","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("prime-subscript-simple","default.default","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("overscore","default.default",'[t] "ModifyingAbove"; [n] children/*[1]; [t] "With"; [n] children/*[2]',"self::overscore",'children/*[2][@role="overaccent"]');(0,sre.NemethRules.defineSpecialisedRule_)("overscore",
"default.default","nemeth.brief",'[t] "ModAbove"; [n] children/*[1]; [t] "With"; [n] children/*[2]');(0,sre.NemethRules.defineSpecialisedRule_)("overscore","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("double-overscore","default.default",'[t] "ModifyingAbove Above"; [n] children/*[1]; [t] "With"; [n] children/*[2]',"self::overscore",'children/*[2][@role="overaccent"]','name(children/*[1])="overscore"','children/*[1]/children/*[2][@role="overaccent"]');(0,sre.NemethRules.defineSpecialisedRule_)("double-overscore",
"default.default","nemeth.brief",'[t] "ModAbove Above"; [n] children/*[1]; [t] "With"; [n] children/*[2]');(0,sre.NemethRules.defineSpecialisedRule_)("double-overscore","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("underscore","default.default",'[t] "ModifyingBelow"; [n] children/*[1]; [t] "With"; [n] children/*[2]',"self::underscore",'children/*[2][@role="underaccent"]');(0,sre.NemethRules.defineSpecialisedRule_)("underscore","default.default","nemeth.brief",'[t] "ModBelow"; [n] children/*[1]; [t] "With"; [n] children/*[2]');
(0,sre.NemethRules.defineSpecialisedRule_)("underscore","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("double-underscore","default.default",'[t] "ModifyingBelow Below"; [n] children/*[1]; [t] "With"; [n] children/*[2]',"self::underscore",'children/*[2][@role="underaccent"]','name(children/*[1])="underscore"','children/*[1]/children/*[2][@role="underaccent"]');(0,sre.NemethRules.defineSpecialisedRule_)("double-underscore","default.default","nemeth.brief",'[t] "ModBelow Below"; [n] children/*[1]; [t] "With"; [n] children/*[2]');
(0,sre.NemethRules.defineSpecialisedRule_)("double-underscore","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("overbar","default.default",'[n] children/*[1]; [t] "overbar"',"self::overscore",'@role="latinletter" or @role="greekletter" or @role="otherletter"','children/*[2][@role="overaccent"]','children/*[2][text()="\u00af" or text()="\uffe3" or text()="\uff3f" or text()="_" or text()="\u203e"]');(0,sre.NemethRules.defineSpecialisedRule_)("overbar","default.default","nemeth.brief",
'[n] children/*[1]; [t] "overBar"');(0,sre.NemethRules.defineSpecialisedRule_)("overbar","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("underbar","default.default",'[n] children/*[1]; [t] "underbar"',"self::underscore",'@role="latinletter" or @role="greekletter" or @role="otherletter"','children/*[2][@role="underaccent"]','children/*[2][text()="\u00af" or text()="\uffe3" or text()="\uff3f" or text()="_" or text()="\u203e"]');(0,sre.NemethRules.defineSpecialisedRule_)("underbar",
"default.default","nemeth.brief",'[n] children/*[1]; [t] "underBar"');(0,sre.NemethRules.defineSpecialisedRule_)("underbar","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("overtilde","default.default",'[n] children/*[1]; [t] "overTilde"',"self::overscore",'children/*[2][@role="overaccent"]','@role="latinletter" or @role="greekletter" or @role="otherletter"','children/*[2][text()="~" or text()="\u02dc" or text()="\u223c" or text()="\uff5e"]');(0,sre.NemethRules.defineSpecialisedRule_)("overtilde",
"default.default","nemeth.brief",'[n] children/*[1]; [t] "overtilde"');(0,sre.NemethRules.defineSpecialisedRule_)("overtilde","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("undertilde","default.default",'[n] children/*[1]; [t] "underTilde"',"self::underscore",'@role="latinletter" or @role="greekletter" or @role="otherletter"','children/*[2][@role="underaccent"]','children/*[2][text()="~" or text()="\u02dc" or text()="\u223c" or text()="\uff5e"]');(0,sre.NemethRules.defineSpecialisedRule_)("undertilde",
"default.default","nemeth.brief",'[n] children/*[1]; [t] "undertilde"');(0,sre.NemethRules.defineSpecialisedRule_)("undertilde","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("matrix-fence","default.default","[n] children/*[1];","self::fenced","count(children/*)=1",'name(children/*[1])="matrix"');(0,sre.NemethRules.defineRule_)("matrix","default.default",'[m] children/* (separator:"\n", join:"");',"self::matrix");(0,sre.NemethRules.defineRuleAlias_)("matrix","self::vector");(0,sre.NemethRules.defineRule_)("matrix-row",
"default.default",'[n] ../../content/*[1] (grammar:enlargeFence); [m] children/* (separator:"\u2800"); [n] ../../content/*[2] (grammar:enlargeFence); ',"self::row");(0,sre.NemethRules.defineRule_)("row-with-label","default.default",'[t] "with Label"; [n] content/*[1]; [t] "EndLabel"(pause: 200); [m] children/* (ctxtFunc:CTXFordinalCounter,context:"Column")',"self::row","content");(0,sre.NemethRules.defineRule_)("row-with-label","nemeth.brief",'[t] "Label"; [n] content/*[1]; [m] children/* (ctxtFunc:CTXFordinalCounter,context:"Column")',
"self::row","content");(0,sre.NemethRules.defineSpecialisedRule_)("row-with-label","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("row-with-text-label","nemeth.sbrief",'[t] "Label"; [t] CSFRemoveParens;[m] children/* (ctxtFunc:CTXFordinalCounter,context:"Column")',"self::row","content",'name(content/cell/children/*[1])="text"');(0,sre.NemethRules.defineRule_)("empty-row","default.default",'[t] "\u2800" (pause:300)',"self::row","count(children/*)=0");(0,sre.NemethRules.defineRule_)("matrix-cell",
"default.default","[n] children/*[1]","self::cell");(0,sre.NemethRules.defineRule_)("empty-cell","default.default",'[t] "\u2800" (pause: 300)',"self::cell","count(children/*)=0");(0,sre.NemethRules.defineRule_)("layout","default.default",'[t] "StartLayout"; [m] children/* (ctxtFunc:CTXFordinalCounter,context:"Row "); [t] "EndLayout"',"self::table");(0,sre.NemethRules.defineRule_)("layout","nemeth.sbrief",'[t] "Layout"; [m] children/* (ctxtFunc:CTXFordinalCounter,context:"Row "); [t] "EndLayout"',
"self::table");(0,sre.NemethRules.defineRule_)("cases","default.default",'[t] "StartLayout"; [t] "Enlarged"; [n] content/*[1];[m] children/* (ctxtFunc:CTXFordinalCounter,context:"Row "); [t] "EndLayout"',"self::cases");(0,sre.NemethRules.defineRule_)("cases","nemeth.sbrief",'[t] "Layout"; [t] "Enlarged"; [n] content/*[1];[m] children/* (ctxtFunc:CTXFordinalCounter,context:"Row "); [t] "EndLayout"',"self::cases");(0,sre.NemethRules.defineRuleAlias_)("layout","self::multiline");(0,sre.NemethRules.defineRule_)("line",
"default.default","[m] children/*","self::line");(0,sre.NemethRules.defineRule_)("line-with-label","default.default",'[t] "with Label"; [n] content/*[1]; [t] "EndLabel" (pause: 200); [m] children/*',"self::line","content");(0,sre.NemethRules.defineSpecialisedRule_)("line-with-label","default.default","nemeth.brief",'[t] "Label"; [n] content/*[1] (pause: 200); [m] children/*');(0,sre.NemethRules.defineSpecialisedRule_)("line-with-label","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("line-with-text-label",
"nemeth.sbrief",'[t] "Label"; [t] CSFRemoveParens; [m] children/*',"self::line","content",'name(content/cell/children/*[1])="text"');(0,sre.NemethRules.defineRule_)("empty-line","default.default",'[t] "Blank"',"self::line","count(children/*)=0","not(content)");(0,sre.NemethRules.defineSpecialisedRule_)("empty-line","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("empty-line","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("empty-line-with-label","default.default",
'[t] "with Label"; [n] content/*[1]; [t] "EndLabel"(pause: 200); [t] "Blank"',"self::line","count(children/*)=0","content");(0,sre.NemethRules.defineSpecialisedRule_)("empty-line-with-label","default.default","nemeth.brief",'[t] "Label"; [n] content/*[1] (pause: 200); [t] "Blank"');(0,sre.NemethRules.defineSpecialisedRule_)("empty-line-with-label","nemeth.brief","nemeth.sbrief");(0,sre.NemethRules.defineRule_)("enclose","default.default",'[t] "StartEnclose"; [t] @role (grammar:localEnclose); [n] children/*[1]; [t] "EndEnclose"',
"self::enclose");(0,sre.NemethRules.defineRuleAlias_)("overbar","self::enclose",'@role="top"');(0,sre.NemethRules.defineRuleAlias_)("underbar","self::enclose",'@role="bottom"');(0,sre.NemethRules.defineRule_)("leftbar","default.default",'[t] "vertical-bar"; [n] children/*[1]',"self::enclose",'@role="left"');(0,sre.NemethRules.defineRule_)("rightbar","default.default",'[n] children/*[1]; [t] "vertical-bar"',"self::enclose",'@role="right"');(0,sre.NemethRules.defineRule_)("crossout","default.default",
'[t] "CrossOut"; [n] children/*[1]; [t] "EndCrossOut"',"self::enclose",'@role="updiagonalstrike" or @role="downdiagonalstrike" or @role="horizontalstrike"');(0,sre.NemethRules.defineRule_)("cancel","default.default",'[t] "CrossOut"; [n] children/*[1]/children/*[1]; [t] "With"; [n] children/*[2]; [t] "EndCrossOut"',"self::overscore",'@role="updiagonalstrike" or @role="downdiagonalstrike" or @role="horizontalstrike"');(0,sre.NemethRules.defineSpecialisedRule_)("cancel","default.default","nemeth.brief");
(0,sre.NemethRules.defineSpecialisedRule_)("cancel","default.default","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("cancel","self::underscore",'@role="updiagonalstrike" or @role="downdiagonalstrike" or @role="horizontalstrike"');(0,sre.NemethRules.defineRule_)("cancel-reverse","default.default",'[t] "CrossOut"; [n] children/*[2]/children/*[1]; [t] "With"; [n] children/*[1]; [t] "EndCrossOut"',"self::overscore",'name(children/*[2])="enclose"','children/*[2][@role="updiagonalstrike" or @role="downdiagonalstrike" or @role="horizontalstrike"]');
(0,sre.NemethRules.defineSpecialisedRule_)("cancel-reverse","default.default","nemeth.brief");(0,sre.NemethRules.defineSpecialisedRule_)("cancel-reverse","default.default","nemeth.sbrief");(0,sre.NemethRules.defineRuleAlias_)("cancel-reverse","self::underscore",'name(children/*[2])="enclose"','children/*[2][@role="updiagonalstrike" or @role="downdiagonalstrike" or @role="horizontalstrike"]');(0,sre.NemethRules.defineRule_)("end-punct","default.default","[m] children/*","self::punctuated",'@role="endpunct"');
...
"self::identifier",'@role="unit"');(0,sre.NemethRules.defineRule_)("unit-square","default.default",'[t] "square"; [n] children/*[1]',"self::superscript",'@role="unit"',"children/*[2][text()=2]",'name(children/*[1])="identifier"');(0,sre.NemethRules.defineRule_)("unit-cubic","default.default",'[t] "cubic"; [n] children/*[1]',"self::superscript",'@role="unit"',"children/*[2][text()=3]",'name(children/*[1])="identifier"');(0,sre.NemethRules.defineRule_)("reciprocal","default.default",'[t] "reciprocal"; [n] children/*[1]',
"self::superscript",'@role="unit"','name(children/*[1])="identifier"','name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'count(preceding-sibling::*)=0 or preceding-sibling::*[@role!="unit"]');(0,sre.NemethRules.defineRule_)("reciprocal","default.default",'[t] "per"; [n] children/*[1]',"self::superscript",'@role="unit"','name(children/*[1])="identifier"','name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",
'preceding-sibling::*[@role="unit"]');(0,sre.NemethRules.defineRule_)("unit-combine","default.default","[m] children/*","self::infixop",'@role="unit"');(0,sre.NemethRules.defineRule_)("unit-divide","default.default",'[n] children/*[1]; [t] "per"; [n] children/*[2]',"self::fraction",'@role="unit"')};sre.NemethRules.componentString_={2:"CSFbaseline",1:"CSFsubscript",0:"CSFsuperscript"};sre.NemethRules.childNumber_={4:2,3:3,2:1,1:4,0:5};
sre.NemethRules.generateTensorRuleStrings_=function(a){var b=[],c="",d="";a=parseInt(a,2);for(var e=0;5>e;e++){var f="children/*["+sre.NemethRules.childNumber_[e]+"]";if(a&1){var g=sre.NemethRules.componentString_[e%3];c="[t] "+g+"Verbose; [n] "+f+";"+c;d="[t] "+g+"Brief; [n] "+f+";"+d}else b.unshift("name("+f+')="empty"');a>>=1}b.push(c);b.push(d);return b};
sre.NemethRules.generateNemethTensorRules_=function(){for(var a="11111 11110 11101 11100 10111 10110 10101 10100 01111 01110 01101 01100".split(" "),b=0,c;c=a[b];b++){var d="tensor"+c;c=sre.NemethRules.generateTensorRuleStrings_(c);var e=c.pop(),f=c.pop(),g=[d,"default.default",f,"self::tensor"].concat(c),h=[d,"nemeth.brief",e,"self::tensor"].concat(c);sre.NemethRules.defineRule_.apply(null,g);sre.NemethRules.defineRule_.apply(null,h);(0,sre.NemethRules.defineSpecialisedRule_)(d,"nemeth.brief","nemeth.sbrief");
g=sre.NemethRules.componentString_[2];f+="; [t]"+g+"Verbose";e+="; [t]"+g+"Brief";d+="-baseline";g=[d,"default.default",f,"self::tensor","following-sibling::*"].concat(c);h=[d,"nemeth.brief",e,"self::tensor","following-sibling::*"].concat(c);sre.NemethRules.defineRule_.apply(null,g);sre.NemethRules.defineRule_.apply(null,h);(0,sre.NemethRules.defineSpecialisedRule_)(d,"nemeth.brief","nemeth.sbrief");d=[d,"self::tensor","not(following-sibling::*)","ancestor::fraction|ancestor::punctuated|ancestor::fenced|ancestor::root|ancestor::sqrt|ancestor::relseq|ancestor::multirel|@embellished"].concat(c);
...
sre.SpeechRuleEngine.prototype.evaluateTree_=function(a){sre.Debugger.getInstance().output(a);var b=sre.Engine.getInstance();if(b.cache){var c=this.getCacheForNode_(a);if(c)return a.attributes&&this.addPersonality_(c,{},!1,a),c}sre.Grammar.getInstance().setAttribute(a);var d=this.activeStore_.lookupRule(a,b.dynamicCstr);if(!d){if(b.strict)return[];c=this.activeStore_.evaluateDefault(a);a.attributes&&this.addPersonality_(c,{},!1,a);this.pushCache_(a,c);return c}sre.Debugger.getInstance().generateOutput(goog.bind(function(){return[d.name,
